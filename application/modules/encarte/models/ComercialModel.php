...
class ComercialModel extends Crud {

    private $table='enc_comercial';
    private $primary_key='cod_comercial';
    ...
    private function atualizar($var) {
        ...
        $criterios=Array(
            $this->primary_key => $fields['cod_comercial']
        );
