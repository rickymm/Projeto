...
class NotificacaoModel extends Crud {

    private $table='enc_notificacao';
    private $primary_key='cod_notificacao';
    ...
    private function atualizar($var) {
        ...
        $criterios=Array(
            $this->primary_key => $fields['cod_notificacao']
        );
