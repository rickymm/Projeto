...
class QuemSomosModel extends Crud {

    private $table='enc_quem_somos';
    private $primary_key='cod_quem_somos';
    ...
    private function atualizar($var) {
        ...
        $criterios=Array(
            $this->primary_key => $fields['cod_quem_somos']
        );
