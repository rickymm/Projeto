    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <p>Nova lista de oportunidades</p>
                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-xs">Em Atendimento</button>
                            </td>
                            <td>
                                <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Ver </a>
                                <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
                                <a href="#" class="btn btn-success btn-xs"><i class="fa fa-check-circle-o"></i> Finalizar </a>
                            </td>
                        </tr>
                        <tr>
                            <td>#</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-disabled btn-xs">Concluída</button>
                            </td>
                            <td>
                                <a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Ver </a>
                                <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
