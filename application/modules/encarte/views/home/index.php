...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <img class="d-block img-fluid" src="https://static.wmobjects.com.br/arquivos/tv-48horas-electrolux-040618.gif" alt="">
        </div>
        <div class="carousel-item">
            <img class="d-block img-fluid" src="https://static.wmobjects.com.br/arquivos/tv_3008_app-walmart.png" alt="">
        </div>
        <div class="carousel-item">
            <img class="d-block img-fluid" src="https://static.wmobjects.com.br/arquivos/tv-saldao-010618.jpg" alt="">
        </div>
    </div>
...
<div class="distribuir">
    <?php foreach ($recentes as $recente) { ?>
        <div class="hovered" onclick="swipeBook('<?php echo $recente->pdf ?>', <?php echo $recente->cod_rede ?>, '<?php echo $recente->nome_encarte ?>')">
            <div class="encarte-img" style="background-image: url('<?php echo base_url("uploads/encarte/imagem_destacada/" . $recente->imagem_destacada) ?>')"> 
            </div>
            <div class="encarte-background-cinza">
                <h6 class="encarte-titulo"><?php echo $recente->nome ?></h6>
                <p class="encarte-texto"><?php echo $this->lang->line("encarte_vence_em") ?> <strong><?php echo $recente->vencimento ?></strong></p>
                <p class="encarte-texto"><img src="img/ic-gps.svg" style="float:left"><?php echo str_replace(',', '', $recente->distancia) . " km" ?></p>
            </div>
        </div>
    <?php } ?>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <section id="como-funciona">
                <h1 class="titulo" style="margin-top: 5%">
                    <?php echo $this->lang->line("encarte_como_funciona") ?>
                </h1>
                <div class="row">
                    <div class="col-md-4">
                        <img src="img/como-funciona1.png">
                        <p>Vitae adipiscing turpis. Aenean ligula nibh, molestie id viverra a, dapibus.</p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="div-btn">
                            <a href="<?php echo base_url('encarte/comercial/consultar'); ?>" role="button" class="btn btn-primary ">
                                <?php echo $this->lang->line("encarte_e_uma_empresa") ?>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <section id="lojas-parceiras">
                <h1 class="titulo">
                    <?php echo $this->lang->line("encarte_lojas_e_redes_parceiras") ?>
                </h1>
                <div class="slider responsive">
                    <div>
                        ...
                        foreach ($redes as $rede) {
                            ?>
                            <div class="lojas-img" style="background-image: url('uploads/logos_imagens/fotoRede/<?php echo $rede->cod_rede ?>.jpg')"> 
                            </div>
                            <?php
                            if ($cont >= 2) {
                                echo '</div> <div>';
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <section id="mapa">
                <form class="form-mapa" action="<?= base_url('encarte/categoria/consultar'); ?>" method="POST">
                    <input type="text" name="estado" class="estado-selecionado" hidden>
                </form>
                <div class="row">
                    <div class="col-md-5 col-12">
                        <h1>
                            <?php echo $this->lang->line("encarte_estamos_perto_de_voce") ?>
                        </h1>
                        <p>
                    ...
                    <div class="col-md-7 col-12 mapa-svg">
                        <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="20px" y="0px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                        <g>
                        <a class="tocantins">
