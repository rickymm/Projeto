                    ...
                    <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                        <div class="m-stack__item m-stack__item--middle m-brand__logo">
                            <a href="index.html" class="m-brand__logo-wrapper">
                                <img alt="" src="<?php echo base_url('img/marca-adm.svg') ?>" width="170px" class="m-brand__logo-default"/>
                                <img alt="" src="<?php echo base_url('img/marca.svg') ?>" class="m-brand__logo-inverse"/>
                            </a>
                        </div>
...
<!--                                <li class="m-nav__item m-topbar__notifications m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center 	m-dropdown--mobile-full-width" data-dropdown-toggle="click" data-dropdown-persistent="true">
                                    ...
                                    <div class="m-dropdown__wrapper" style="width: 320px; margin-left: -160px;">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center">
                                                ...
                                                <span class="m-dropdown__header-subtitle">
                                                    Notificações de Problemas nos Encartes
                                                </span>
                                            </div>
                                            <div class="m-dropdown__body">
                                                ...
                                                <div class="m-card-user m-card-user--skin-light">
                                                    <div class="m-card-user__details">
                                                        ...
                                                        <a href="" class="m-card-user__email m--font-weight-300 m-link">
                                                            <?php echo strtolower($this->session->usuario->email); ?>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="m-dropdown__content">
                                                    <ul class="m-nav m-nav--skin-light">
                                                        ...
                                                        <li class="m-nav__item">
                                                            <a href="<?php echo base_url('encarte/usuario/perfil') ?>" class="m-nav__link">
                                                        ...
                                                        <?php if ($this->session->usuario->cod_funcao == "0") { ?>
                                                            <li class="m-nav__item">
                                                                <a href="<?php echo base_url('encarte/usuario') ?>" class="m-nav__link">
                                                        ...
                                                        <?php } ?>
                                                        <!--                                                        <li class="m-nav__item">
                                                                                                                    <a href="<?php echo base_url('conta/perfil') ?>" class="m-nav__link">
                                                        ...
                                                        <li class="m-nav__separator m-nav__separator--fit"></li>
                                                        <li class="m-nav__item">
                                                            <a href="<?php echo base_url('encarte/conta/sair') ?>" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">
                                                                Sair
                                                            </a>
                                                        </li>
                                                    </ul>
    ...
    <div class="m-header__bottom">
        <div class="m-container m-container--fluid m-container--full-height m-page__container">
            <div class="m-stack m-stack--ver m-stack--desktop">
                <?php $this->load->view('themes/encarte/horizontal_menu'); ?>
            </div>
        </div>
    </div>
</header>
