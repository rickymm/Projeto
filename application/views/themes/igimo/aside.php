...
<html lang="en" >
	...
	<head>
        ...
        <!--begin::Base Styles -->  
        <!--begin::Page Vendors -->
		<link href="<?php echo base_url('themes/igimo/') ?>assets/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors -->
		<link href="<?php echo base_url('themes/igimo/') ?>assets/vendors/base/vendors.bundle.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('themes/igimo/') ?>assets/demo/default/base/style.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Base Styles -->
		<link rel="shortcut icon" href="<?php echo base_url('themes/igimo/') ?>assets/demo/default/media/img/logo/favicon.ico" />
	</head>
	<!-- end::Head -->
    <!-- end::Body -->
							...
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="index.html" class="m-brand__logo-wrapper">
										<img alt="" src="<?php echo base_url('themes/igimo/') ?>assets/demo/default/media/img/logo/logo_default_dark.png"/>
									</a>
								</div>
										...
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless m--img-centered" alt=""/>
												</span>
													...
													<div class="m-dropdown__header m--align-center" style="background: url(assets/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
														<div class="m-card-user m-card-user--skin-dark">
															<div class="m-card-user__pic">
																<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless" alt=""/>
															</div>
										...
										<div class="m-widget4">
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/client-logos/logo3.png" alt="">
												</div>
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/client-logos/logo1.png" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														FlyThemes
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/client-logos/logo2.png" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														AirApp
									...
									<div class="m-portlet__body">
										<div class="m-widget19">
											<div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style="min-height-: 286px">
												<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//blog/blog1.jpg" alt="">
											...
											<div class="m-widget19__content">
												<div class="m-widget19__header">
													<div class="m-widget19__user-img">
														<img class="m-widget19__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//users/user1.jpg" alt="">
													</div>
									...
									<div class="m-portlet__body">
										<div class="m-widget3">
											<div class="m-widget3__item">
												<div class="m-widget3__header">
													<div class="m-widget3__user-img">
														<img class="m-widget3__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/user1.jpg" alt="">
													</div>
											...
											<div class="m-widget3__item">
												<div class="m-widget3__header">
													<div class="m-widget3__user-img">
														<img class="m-widget3__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/user4.jpg" alt="">
													</div>
													<div class="m-widget3__info">
														<span class="m-widget3__username">
															Lebron King James
											...
											<div class="m-widget3__item">
												<div class="m-widget3__header">
													<div class="m-widget3__user-img">
														<img class="m-widget3__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/user5.jpg" alt="">
													</div>
													<div class="m-widget3__info">
														<span class="m-widget3__username">
															Deb Gibson
												...
												<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30"">
													...
													<div class="m-timeline-2__item m--margin-top-30">
														...
														<div class="m-list-pics m-list-pics--sm m--padding-left-20">
															<a href="#">
																<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/100_4.jpg" title="">
															</a>
															<a href="#">
																<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/100_13.jpg" title="">
															</a>
															<a href="#">
																<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/100_11.jpg" title="">
															</a>
															<a href="#">
																<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/users/100_14.jpg" title="">
															</a>
														</div>
													</div>
													<div class="m-timeline-2__item m--margin-top-30">
								...
								<div class="m-portlet m-portlet--full-height m-portlet--fit ">
									...
									<div class="m-portlet__body">
										...
										<div class="m-widget4 m-widget4--chart-bottom" style="min-height: 480px">
											...
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/client-logos/logo4.png" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														Starbucks
												...
												<div class="m-widget5">
													<div class="m-widget5__item">
														<div class="m-widget5__pic">
															<img class="m-widget7__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//products/product6.jpg" alt="">
														</div>
													...
													<div class="m-widget5__item">
														<div class="m-widget5__pic">
															<img class="m-widget7__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//products/product10.jpg" alt="">
														</div>
														<div class="m-widget5__content">
															<h4 class="m-widget5__title">
																Branding Mockup
													...
													<div class="m-widget5__item">
														<div class="m-widget5__pic">
															<img class="m-widget7__img" src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//products/product11.jpg" alt="">
														</div>
														<div class="m-widget5__content">
															<h4 class="m-widget5__title">
																Awesome Mobile App
								...
								<div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
									...
									<div class="m-portlet__body">
										<div class="m-widget4">
											<div class="m-widget4__item">
												<div class="m-widget4__img m-widget4__img--logo">
													<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img/client-logos/logo5.png" alt="">
												</div>
												<div class="m-widget4__info">
													<span class="m-widget4__title">
														Trump Themes
...
<!-- begin::Footer -->
							...
							<div class="m-messenger__messages">
								<div class="m-messenger__message m-messenger__message--in">
									<div class="m-messenger__message-pic">
										<img src="<?php echo base_url('themes/igimo/') ?>assets/app/media/img//users/user3.jpg" alt=""/>
									</div>
		...
		<!-- begin::Quick Nav -->	
    	<!--begin::Base Scripts -->
		<script src="<?php echo base_url('themes/igimo/') ?>assets/vendors/base/vendors.bundle.js" type="text/javascript"></script>
		<script src="<?php echo base_url('themes/igimo/') ?>assets/demo/default/base/scripts.bundle.js" type="text/javascript"></script>
		<!--end::Base Scripts -->   
        <!--begin::Page Vendors -->
		<script src="<?php echo base_url('themes/igimo/') ?>assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
		<!--end::Page Vendors -->  
        <!--begin::Page Snippets -->
		<script src="<?php echo base_url('themes/igimo/') ?>assets/app/js/dashboard.js" type="text/javascript"></script>
		<!--end::Page Snippets -->
	</body>
	<!-- end::Body -->
</html>
