...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    ...
    type: {
      ...
      alphanum: "Informe um valor alfanumérico."
    },
    notblank: "This value should not be blank.",
    required: "Preencha esse campo.",
    pattern: "Favor informar um valor válido.",
    min: "This value should be greater than or equal to %s.",
    max: "This value should be lower than or equal to %s.",
    range: "This value should be between %s and %s.",
    minlength: "Esse valor é muito curto. Deve ter %s caracteres ou mais.",
    maxlength: "Esse valor é muito longo. Deve ter %s caracteres ou menos.",
